...
const EditProfile = (props) => {
  ...
  const picExtension = profile.split(".").pop();
...
const reset = () => {
  ...
  return (
    <div className="bg-homepage bg-black-60 bg-cover text-white pb-13  mobile:pt-10 pt-25">
      <div className="polygon-token bg-black-60 m-auto w-eiy relative tb:pb-fex pb-eex">
        <div className="font-black font-EurostileExtended text-left text-white pt-fff pl-24 tb:text-ft11 text-ft8 mobile:text-center mobile:pl-0">
          USER PROFILE
        </div>
          ...
          <div className="w-full pt-7">
                ...
                >
                  <div class="hex-pic relative ">
                    {(picExtension === "mp4" || picExtension === "mov") ?
                      (<video className="object-cover dp-hex" src={profile} />) :
                    (                    <img
                      className={`${picExtension === "mp3" ? "audio-nft":""} dp-hex object-cover `}
                      src={profile ? picExtension === "mp3" ? "/images/music-bg.png" : profile : "/images/default-image.svg"}
                    />)  
                  }
            ...
            <div className="w-full  pt-7">
              ...
              <div className="flex justify-between">
                ...
                <button
                  class="market-button xl:w-32 w-23 xl:h-12 h-8 rounded-3xl text-white bg-blue-60 relative overflow-hidden border border-blue-80 text-ft2"
                  type="button"
                >
                  Connect
                </button>
        ...
        <div class="flex items-center mt-8 mb-8">
          <div class="w-full mt-tex flex justify-center">
            <button
              class="market-button xl:w-45 xl:h-12 w-30 h-8 rounded-3xl text-white bg-blue-60 relative overflow-hidden border mr-7.5 border-blue-80 text-ft2"
              type="button"
              onClick={editData}
            >
              Save changes
