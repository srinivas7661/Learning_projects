    ...
    >
      {(() => {
        switch (props.steps) {
          case 1:
            return (
              <div className="tb:w-104.5 w-full tb:h-83 h-100 rounded-md opacity-100">
                ...
                <div className="flex flex-col items-center justify-center text-center pt-1.25 px-0 pb-0">
                  <div className="text-ft2 text-white mx-0 mt-0">
                    Please wait we are creating your NFT,
                    <br />
                    <br />
                    Confirm the transaction on MetaMask. NFT will not be created{" "}
                    <br /> if you close or refresh the page or close the
                    <br /> Metamask window.
                  </div>
                </div>
              </div>
          ...
          case 2:
            return (
              <div className="w-104.5 h-83 bg-black-60 rounded-md opacity-100">
                ...
                <div className="flex flex-col items-center justify-center text-center pt-1.25 px-0 pb-0">
                  <div className="text-ft2 text-white mx-0 mt-0">
                    You have successfully created NFT
                  </div>
                </div>
                <ButtonContainer>
                  <CancelButton onClose={props.handleClose}>Close</CancelButton>
                </ButtonContainer>
              </div>
            );
          default:
